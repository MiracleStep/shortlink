...
public interface ShortLinkRemoteService {
    ...
    default Result<ShortLinkBatchCreateRespDTO> batchCreateShortLink(ShortLinkBatchCreateReqDTO requestParam) {
        ...
        return com.alibaba.fastjson2.JSON.parseObject(resultBodyStr, new com.alibaba.fastjson2.TypeReference<>() {
        });
    }
     ...
     * @return
     */
    default public Result<String> getTitleByUrl(String url) {
        String resultPageStr = HttpUtil.get("http://127.0.0.1:8001/api/short-link/title?url=" + url);
        return JSON.parseObject(resultPageStr, new TypeReference<>(){});
    }
     ...
     * @return
     */
    default public void saveRecycleBin(RecycleBinSaveReqDTO requestParam) {
     ...
     * 分页查询回收站短链接
     */
    default public Result<IPage<ShortLinkPageRespDTO>> pageRecycleShortLink(ShortLinkRecycleBinPageReqDTO requestParam) {
        Map<String, Object> requestMap = new HashMap<>();
